...
const TherapistDetails = () => {
  ...
  useEffect(() => {
    if (therapist?._id && therapist?.firstName && therapist?.lastName) {
      try {
        // Save therapist ID
        localStorage.setItem("selectedTherapistId", therapist._id);

        // Save therapist name
        const therapistName = `${therapist.firstName} ${therapist.lastName}`;
        localStorage.setItem("selectedTherapistName", therapistName);

        // console.log("Therapist details saved to localStorage:", {
        //   id: therapist._id,
        //   name: therapistName,
        // });
      } catch (error) {
        console.error("Error saving therapist details to localStorage:", error);
      }
    }
  }, [therapist]);
  ...
  return (
    <div className="bg-[#F5F5DC] px-12 py-10">
        ...
        <div className="pt-8">
          ...
          <div className="flex flex-col">
            <div className="lg:flex justify-start gap-3">
              <div>
                <img
                  ...
                  alt="therapist"
                  className="w-[250px] h-[250px] md:w-64 md:h-64 lg:w-[200px] lg:h-[200px] mb-4 rounded-full border-4 border-gray-300 object-cover mx-auto"
                />
              </div>
              ...
              <div>
                <div className="mt-4">
                  <h2 className="text-3xl font-semibold text-gray-900 lg:text-4xl">
                    {therapist?.firstName || "Name not available"}{" "}
                    {therapist?.lastName || "Name is not available"}
                  </h2>
                </div>
            ...
            <div className="mt-4 flex flex-col justify-start gap-4 lg:flex-row lg:gap-2 lg:items-center mb-6 ">
              ...
              <div className="playfair-display-select block lg:hidden  md:mb-2 ">
                    ...
                    >
                      ...
                      <div className="relative bg-white rounded-lg shadow-lg max-w-lg w-[90vw] max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-4">
                          ...
                          <p>
                            {therapist?.firstName} is available for on-site
                            audio calls.
                          </p>
...
>
  Book Appointment
              ...
              <div className="playfair-display-select hidden lg:block md:hidden w-fit lg:ml-0 ml-5">
