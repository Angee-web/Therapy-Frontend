import { postQuestionnaire, resetQuestionnaireState } from "@/store/therapy/question-slice";
...
const Questionnaire = ({ onComplete, onDataChange }) => {
  ...
  useEffect(() => {
    ...
    const therapistId = localStorage.getItem("selectedTherapistId"); // Get therapist ID from localStorage
