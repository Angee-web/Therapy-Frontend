...
import LandingQuestion from "./TherapyLandingQuestions";
  ...
  return (
    <div className="bg-[#F5F5DC]">
      <motion.main
        ...
        initial="initial"
        animate="animate"
        className="flex items-center justify-center h-auto flex-wrap"
      >
      ...
      <section className="p-5 mt-5 flex flex-col justify-center items-center text-center">
        ...
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className=" mt-5 flex flex-col md:flex-row gap-3 justify-center  items-center lg:justify-between w-full lg:text-lg "
        >
          <motion.div
            variants={SlideLeft(0.2)}
            initial="initial"
            whileInView="animate"
            className="flex flex-col justify-center items-center w-[250px] px-4 h-[250px] lg:w-[350px] lg:h-[300px] gap-3 "
          >
            <img
      ...
      >
        <motion.h2
          ...
          initial="initial"
          whileInView="animate"
          className="font-bold text-xl md:text-xl lg:text-4xl"
        >
          THERAPY CATEGORY
        </motion.h2>
      ...
      <motion.section
        ...
        initial="initial"
        whileInView="animate"
        className="p-5 mt-5 flex flex-col justify-center items-center  "
      >
        {/* first div */}
        <motion.div
          variants={SlideLeft(0.3)}
          initial="initial"
          whileInView="animate"
          className="flex flex-col md:flex-row gap-4 justify-center items-center bg-black text-white p-5 rounded-xl"
        >
          <span>
            <img
        ...
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className="flex flex-col justify-center items-center mt-5 p-5 max-w-lg text-center gap-5"
        >
        ...
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className="flex flex-col md:flex-row gap-4 justify-center items-center bg-black text-white p-5 rounded-xl mt-5"
        >
          <span className="flex flex-col gap-4 p-5">
            <h2 className="font-bold text-xl lg:text-3xl text-center">
        ...
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className="flex flex-col justify-center items-center mt-5 p-5 max-w-xl text-center gap-5"
        >
      ...
      <motion.section
        ...
        initial="initial"
        whileInView="animate"
        className="flex flex-col md:flex-row gap-4 justify-center items-center mt-5 p-5"
      >
        <motion.div
          variants={SlideLeft(0.3)}
          initial="initial"
          whileInView="animate"
          className="bg-black max-w-[20rem] lg:max-w-lg xl:max-w-xl h-auto p-4"
        >
          <img
